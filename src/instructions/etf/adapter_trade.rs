...
use crate::core::types::{AdapterParams, TradeParams};
...
/// ETF资产适配器交易指令实现
pub fn adapter_trade_etf(ctx: Context<AdapterTradeEtf>, adapter_params: AdapterParams, trade_params: TradeParams) -> Result<()> {
