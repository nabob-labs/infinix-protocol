...
/// ETF资产批量转账指令实现
pub fn batch_transfer_etf(ctx: Context<BatchTransferEtf>, amounts: Vec<u64>, params: TradeParams) -> anchor_lang::Result<()> {
    ...
    require!(to_etf.asset_type == crate::core::types::AssetType::ETF, ProgramError::InvalidAssetType);
