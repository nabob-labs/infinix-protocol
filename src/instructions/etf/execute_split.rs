...
/// ETF资产执行拆分指令实现
pub fn execute_split_etf(ctx: Context<ExecuteSplitEtf>, amount: u64, params: TradeParams) -> anchor_lang::Result<()> {
    ...
    require!(new_etf.asset_type == crate::core::types::AssetType::ETF, ProgramError::InvalidAssetType);
