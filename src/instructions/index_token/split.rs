...
/// IndexToken资产split指令账户上下文
#[derive(Accounts)]
pub struct SplitIndexToken<'info> {
    #[account(mut)]
...
/// IndexToken资产split指令实现
/// - ctx: Anchor账户上下文，自动校验权限与生命周期
/// - amount: 拆分数量，类型安全
pub fn split_index_token(ctx: Context<SplitIndexToken>, amount: u64) -> anchor_lang::Result<()> {
