...
use crate::core::types::{AdapterParams, TradeParams, AssetType};
...
/// RWA资产适配器交易指令实现
pub fn adapter_trade_rwa(ctx: Context<AdapterTradeRwa>, adapter_params: AdapterParams, trade_params: TradeParams) -> Result<()> {
