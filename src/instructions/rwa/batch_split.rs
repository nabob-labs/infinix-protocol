...
/// RWA资产批量拆分指令实现
pub fn batch_split_rwa(ctx: Context<BatchSplitRwa>, amounts: Vec<u64>, params: BatchTradeParams) -> Result<()> {
    ...
    for new_rwa in new_rwas.iter() {
        require!(new_rwa.asset_type == crate::core::types::AssetType::RWA, crate::error::ProgramError::InvalidAssetType);
    }
