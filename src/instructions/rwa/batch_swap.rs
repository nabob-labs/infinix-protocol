...
/// RWA资产批量swap指令实现
pub fn batch_swap_rwa(ctx: Context<BatchSwapRwa>, params: BatchTradeParams) -> anchor_lang::Result<()> {
    ...
    require!(from.asset_type == crate::core::types::AssetType::RWA, ProgramError::InvalidAssetType);
    for to in to_rwas.iter() {
        require!(to.asset_type == crate::core::types::AssetType::RWA, ProgramError::InvalidAssetType);
    }
