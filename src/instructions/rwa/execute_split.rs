...
/// RWA资产执行拆分指令实现
pub fn execute_split_rwa(ctx: Context<ExecuteSplitRwa>, amount: u64, params: TradeParams) -> anchor_lang::Result<()> {
    ...
    require!(new_rwa.asset_type == AssetType::RWA, ProgramError::InvalidAssetType);
