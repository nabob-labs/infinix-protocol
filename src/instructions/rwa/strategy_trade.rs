...
/// RWA资产策略交易指令实现
pub fn strategy_trade_rwa(ctx: Context<StrategyTradeRwa>, params: { strategy: StrategyParams, swap_params: Option<TradeParams>, price_params: Option<OracleParams>, exec_params: Option<TradeParams> }) -> anchor_lang::Result<()> {
