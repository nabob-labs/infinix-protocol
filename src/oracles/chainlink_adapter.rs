...
// ========================= Chainlink 预言机适配器桥接实现 =========================
// 本模块为 Chainlink 预言机提供 Anchor 兼容的桥接适配器，
...
impl AdapterTrait for ChainlinkAdapter {
    /// 返回适配器名称
    fn name(&self) -> &'static str { "chainlink" }
    /// 返回适配器版本号
